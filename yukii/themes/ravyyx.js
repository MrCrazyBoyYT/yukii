...
module.exports = async function ({
    ...
    const background = await canvas.loadImage(
        "https://ik.imagekit.io/MrCrazyBoyYT/Images/Muzicard/yukii_ravyy.png"
    );

    const bg2 = await canvas.loadImage(
        "https://ik.imagekit.io/MrCrazyBoyYT/Images/Muzicard/yukii_ravyy.png"
    );
    ...
    const radius = thumbnailCanvas.width / 2;

    thumbnailMaskCtx.beginPath();
    thumbnailMaskCtx.arc(radius, radius, radius, 0, 2 * Math.PI);
